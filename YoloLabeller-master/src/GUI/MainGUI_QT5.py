...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_ImportDataset = QtWidgets.QPushButton(self.tab_Segmentation)
        self.pushButton_ImportDataset.setObjectName("pushButton_ImportDataset")
        self.verticalLayout_9.addWidget(self.pushButton_ImportDataset)
        spacerItem6 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_9.addItem(spacerItem6)
        self.groupBox_3 = QtWidgets.QGroupBox(self.tab_Segmentation)
        self.groupBox_3.setObjectName("groupBox_3")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.groupBox_3)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.checkBox_showMascara = QtWidgets.QCheckBox(self.groupBox_3)
        self.checkBox_showMascara.setObjectName("checkBox_showMascara")
        self.gridLayout_3.addWidget(self.checkBox_showMascara, 0, 1, 1, 1)
        self.checkBox_showContorno = QtWidgets.QCheckBox(self.groupBox_3)
        self.checkBox_showContorno.setObjectName("checkBox_showContorno")
        self.gridLayout_3.addWidget(self.checkBox_showContorno, 0, 2, 1, 1)
        self.groupBox_4 = QtWidgets.QGroupBox(self.groupBox_3)
        self.groupBox_4.setTitle("")
        self.groupBox_4.setObjectName("groupBox_4")
        self.verticalLayout_11 = QtWidgets.QVBoxLayout(self.groupBox_4)
        self.verticalLayout_11.setObjectName("verticalLayout_11")
        self.checkBox_onlyOneClass = QtWidgets.QCheckBox(self.groupBox_4)
        self.checkBox_onlyOneClass.setObjectName("checkBox_onlyOneClass")
        self.verticalLayout_11.addWidget(self.checkBox_onlyOneClass)
        self.comboBox_Class = QtWidgets.QComboBox(self.groupBox_4)
        ...
        self.verticalLayout_11.addWidget(self.comboBox_Class)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(self.tab_Segmentation)
        self.groupBox_2.setObjectName("groupBox_2")
        self.verticalLayout_10 = QtWidgets.QVBoxLayout(self.groupBox_2)
        self.verticalLayout_10.setObjectName("verticalLayout_10")
        self.checkBox_EnablePaint = QtWidgets.QCheckBox(self.groupBox_2)
        self.checkBox_EnablePaint.setObjectName("checkBox_EnablePaint")
        self.verticalLayout_10.addWidget(self.checkBox_EnablePaint)
        ...
        self.pushButton_Dibujar = QtWidgets.QPushButton(self.frame_2)
        self.pushButton_Dibujar.setEnabled(False)
        self.pushButton_Dibujar.setObjectName("pushButton_Dibujar")
        self.horizontalLayout_6.addWidget(self.pushButton_Dibujar)
        self.pushButton_Borrar = QtWidgets.QPushButton(self.frame_2)
        self.pushButton_Borrar.setEnabled(False)
        self.pushButton_Borrar.setObjectName("pushButton_Borrar")
        self.horizontalLayout_6.addWidget(self.pushButton_Borrar)
        ...
        self.pushButton_ExportContornos = QtWidgets.QPushButton(self.groupBox_2)
        self.pushButton_ExportContornos.setEnabled(False)
        self.pushButton_ExportContornos.setObjectName("pushButton_ExportContornos")
        self.verticalLayout_10.addWidget(self.pushButton_ExportContornos)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_ImportDataset.setText(_translate("MainWindow", "Importar Dataset"))
        self.groupBox_3.setTitle(_translate("MainWindow", "Visualize"))
        self.checkBox_showMascara.setText(_translate("MainWindow", "Mascara"))
        self.checkBox_showContorno.setText(_translate("MainWindow", "Contorno"))
        ...
        self.groupBox_2.setTitle(_translate("MainWindow", "Paint"))
        self.checkBox_EnablePaint.setText(_translate("MainWindow", "Habilitar Pintado"))
        self.pushButton_Dibujar.setText(_translate("MainWindow", "Dibujar"))
        self.pushButton_Borrar.setText(_translate("MainWindow", "Borrar"))
        self.label_3.setText(_translate("MainWindow", "Size Pixel"))
        self.pushButton_ExportContornos.setText(_translate("MainWindow", "EXPORTAR"))
